...
class Environment(object):
    ...
    def init_population(self, A, num_nodes, o, d):
        ...
        while len(population) < self.GA_SIZE_POP and trials < 300:
            allels = list(range(num_nodes)) # router indexes
            chromosome = self.make_chromosome(A, num_nodes, o, d, allels)
    ...
    def mutate(self, adj_mtx, normal_chrom, num_nodes):
        ...
        R = self.make_chromosome(adj_mtx, num_nodes, start_router, end_router, allels)
        ...
        return self.remove_duplicate(trans_chrom)
